...
/// 
/// 
///  @returns NSArray<SWGInventoryGroup>*
///
-(NSNumber*) allGetWithCompletionHandler: 
    ...
    return [self.apiClient requestWithPath: resourcePath
                       ...
                       responseContentType: responseContentType
                              responseType: @"NSArray<SWGInventoryGroup>*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((NSArray<SWGInventoryGroup>*)data, error);
                                }
                           }
          ];
}
...
-(NSNumber*) itemAddPostWithItem: (SWGItem*) item
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"SWGItem*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((SWGItem*)data, error);
                                }
                           }
          ];
}
...
-(NSNumber*) itemsPostWithQuery: (SWGDictionary*) query
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"NSArray<SWGItem>*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((NSArray<SWGItem>*)data, error);
                                }
                           }
          ];
}
...
-(NSNumber*) itemsallfieldsPostWithQuery: (SWGDictionary*) query
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"NSArray<SWGDictionary>*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((NSArray<SWGDictionary>*)data, error);
                                }
                           }
          ];
}
...
-(NSNumber*) servicesPostWithService: (SWGService*) service
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"SWGService*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((SWGService*)data, error);
                                }
                           }
          ];
}
