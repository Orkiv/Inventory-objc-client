...
-(NSNumber*) itemsallfieldsPostWithQuery: (INVDictionary*) query
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/items/?allfields"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"NSArray<INVDictionary>*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((NSArray<INVDictionary>*)data, error);
                                }
                           }
          ];
}
...
-(NSNumber*) queryallfieldsPostWithPage: (NSNumber*) page
    ...
    query: (INVDictionary*) query
    completionHandler: (void (^)(NSArray<INVDictionary>* output, NSError* error)) handler {
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/query/?allfields"];
