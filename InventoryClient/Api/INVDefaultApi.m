...
@interface INVDefaultApi ()

@property (nonatomic, strong) NSMutableDictionary *defaultHeaders;

@end

@implementation INVDefaultApi

NSString* kINVDefaultApiErrorDomain = @"INVDefaultApiErrorDomain";
NSInteger kINVDefaultApiMissingParamErrorCode = 234513;
...
- (instancetype) init {
    self = [super init];
    if (self) {
        INVConfiguration *config = [INVConfiguration sharedConfig];
        if (config.apiClient == nil) {
            config.apiClient = [[INVApiClient alloc] init];
        }
...
- (id) initWithApiClient:(INVApiClient *)apiClient {
    self = [super init];
    if (self) {
...
+ (instancetype)sharedAPI {
    static INVDefaultApi *sharedAPI;
...
-(NSUInteger) requestQueueSize {
    return [INVApiClient requestQueueSize];
}
...
/// 
/// 
///  @returns NSArray<INVInventoryGroup>*
///
-(NSNumber*) allGetWithCompletionHandler: 
    (void (^)(NSArray<INVInventoryGroup>* output, NSError* error)) handler {
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/all/"];
    ...
    NSArray *authSettings = @[@"APIKey", @"AccountID"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                       ...
                       responseContentType: responseContentType
                              responseType: @"NSArray<INVInventoryGroup>*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((NSArray<INVInventoryGroup>*)data, error);
                                }
                           }
          ];
}
...
-(NSNumber*) categoriesDeleteWithId: (NSString*) _id
    ...
    if (_id == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kINVDefaultApiErrorDomain code:kINVDefaultApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    }
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"INVResponse*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((INVResponse*)data, error);
                                }
                           }
          ];
}
...
-(NSNumber*) categoriesPostWithQuery: (INVCategory*) query
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"NSArray<INVCategory>*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((NSArray<INVCategory>*)data, error);
                                }
                           }
          ];
}
...
-(NSNumber*) categoriesPutWithId: (NSString*) _id
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"INVCategory*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((INVCategory*)data, error);
                                }
                           }
          ];
}
...
-(NSNumber*) itemAddPostWithItem: (INVItemRequest*) item
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/item/add/"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"INVItem*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((INVItem*)data, error);
                                }
                           }
          ];
}
...
-(NSNumber*) itemAddbulkPostWithItems: (NSArray<INVItemRequest>*) items
    ...
    if (items == nil) {
        ...
        if(handler) {
            NSDictionary * userInfo = @{NSLocalizedDescriptionKey : [NSString stringWithFormat:NSLocalizedString(@"Missing required parameter '%@'", nil),@"items"] };
            NSError* error = [NSError errorWithDomain:kINVDefaultApiErrorDomain code:kINVDefaultApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/item/addbulk/"];
...
-(NSNumber*) itemDeleteWithId: (NSString*) _id
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/item/"];
...
-(NSNumber*) itemMediaDeleteWithImageurl: (NSString*) imageurl
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/item-media/"];
...
-(NSNumber*) itemsCountPostWithMinprice: (NSNumber*) minprice
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/items/count/"];
...
-(NSNumber*) itemsPostWithMinprice: (NSNumber*) minprice
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"NSArray<INVItem>*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((NSArray<INVItem>*)data, error);
                                }
                           }
          ];
}
...
-(NSNumber*) ordersPostWithQuery: (INVOrderRequest*) query
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"NSArray<INVOrder>*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((NSArray<INVOrder>*)data, error);
                                }
                           }
          ];
}
...
-(NSNumber*) ordersServicesPostWithQuery: (INVOrderRequest*) query
    completionHandler: (void (^)(NSArray<INVOrder>* output, NSError* error)) handler {
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/orders/services/"];
...
-(NSNumber*) queryPostWithPage: (NSNumber*) page
    ...
    query: (INVItemRequest*) query
    completionHandler: (void (^)(NSArray<INVItem>* output, NSError* error)) handler {
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/query/"];
...
-(NSNumber*) servicesDeleteWithId: (NSString*) _id
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/services/"];
...
-(NSNumber*) servicesGetWithCompletionHandler: 
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"NSArray<INVService>*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((NSArray<INVService>*)data, error);
                                }
                           }
          ];
}
...
-(NSNumber*) servicesOpenGetWithId: (NSString*) _id
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/services/open/"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"INVService*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((INVService*)data, error);
                                }
                           }
          ];
}
...
-(NSNumber*) variationDeleteWithId: (NSString*) _id
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/variation/"];
...
-(NSNumber*) variationGetWithId: (NSString*) _id
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"INVVariation*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((INVVariation*)data, error);
                                }
                           }
          ];
}
...
-(NSNumber*) writeDeleteWithId: (NSString*) _id
    completionHandler: (void (^)(INVResponse* output, NSError* error)) handler {
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/write/"];
...
-(NSNumber*) writePostWithEventRequest: (INVEventRequest*) eventRequest
    ...
    if (eventRequest == nil) {
        NSParameterAssert(eventRequest);
        if(handler) {
            NSDictionary * userInfo = @{NSLocalizedDescriptionKey : [NSString stringWithFormat:NSLocalizedString(@"Missing required parameter '%@'", nil),@"eventRequest"] };
            NSError* error = [NSError errorWithDomain:kINVDefaultApiErrorDomain code:kINVDefaultApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
