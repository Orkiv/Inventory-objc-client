#import "INVConfiguration.h"

@interface INVConfiguration ()
...
@implementation INVConfiguration

#pragma mark - Singleton Methods

+ (instancetype) sharedConfig {
    static INVConfiguration *shardConfig = nil;
...
- (instancetype) init {
    ...
    if (self) {
        self.apiClient = nil;
        self.host = @"https://www.orkiv.com/i/api";
        self.username = @"";
        self.password = @"";
        self.accessToken= @"";
        self.verifySSL = YES;
        ...
        self.logger = [INVLogger sharedLogger];
    }
    return self;
}
    ...
    return @{
               ...
               @"AccountID":
                   @{
                       ...
                       @"in": @"header",
                       @"key": @"accountid",
                       @"value": [self getApiKeyWithPrefix:@"accountid"]
                   },
               };
}
