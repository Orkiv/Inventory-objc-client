 ...
 */
extern NSString *const INVResponseObjectErrorKey;

@interface INVApiClient : AFHTTPSessionManager

@property(nonatomic, assign) NSURLRequestCachePolicy cachePolicy;
@property(nonatomic, assign) NSTimeInterval timeoutInterval;
@property(nonatomic, readonly) NSOperationQueue* queue;

/// In order to ensure the HTTPResponseHeaders are correct, it is recommended to initialize one INVApiClient instance per thread.
@property(nonatomic, readonly) NSDictionary* HTTPResponseHeaders;

@property(nonatomic, strong) id<INVResponseDeserializer> responseDeserializer;

@property(nonatomic, strong) id<INVSanitizer> sanitizer;
/**
 * Clears Cache
 */
+(void)clearCache;
...
/**
 * INVConfiguration return sharedConfig
 *
 * @return INVConfiguration
 */
