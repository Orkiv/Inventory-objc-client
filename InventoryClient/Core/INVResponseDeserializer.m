#import "INVResponseDeserializer.h"
#import <JSONModel/JSONModel.h>
#import <ISO8601/ISO8601.h>

NSString *const INVDeserializationErrorDomainKey = @"INVDeserializationErrorDomainKey";

NSInteger const INVTypeMismatchErrorCode = 143553;

NSInteger const INVEmptyValueOccurredErrorCode = 143509;

NSInteger const INVUnknownResponseObjectErrorCode = 143528;


@interface INVResponseDeserializer ()
...
@implementation INVResponseDeserializer
...
-(NSError *)typeMismatchErrorWithExpectedType:(NSString *)expected data:(id)data {
    ...
    return [NSError errorWithDomain:INVDeserializationErrorDomainKey code:INVTypeMismatchErrorCode userInfo:userInfo];
}
...
-(NSError *)emptyValueOccurredError {
    ...
    NSDictionary * userInfo = @{NSLocalizedDescriptionKey : message};
    return [NSError errorWithDomain:INVDeserializationErrorDomainKey code:INVEmptyValueOccurredErrorCode userInfo:userInfo];
}
...
-(NSError *)unknownResponseErrorWithExpectedType:(NSString *)expected data:(id)data  {
    ...
    NSDictionary * userInfo = @{NSLocalizedDescriptionKey : message};
    return [NSError errorWithDomain:INVDeserializationErrorDomainKey code:INVUnknownResponseObjectErrorCode userInfo:userInfo];
}
