 ...
 */
extern NSString *const INVDeserializationErrorDomainKey;

/**
 * Code for deserialization type mismatch error
 */
extern NSInteger const INVTypeMismatchErrorCode;

/**
 * Code for deserialization empty value error
 */
extern NSInteger const INVEmptyValueOccurredErrorCode;

/**
 * Error code for unknown response
 */
extern NSInteger const INVUnknownResponseObjectErrorCode;

@protocol INVResponseDeserializer <NSObject>
...
@interface INVResponseDeserializer : NSObject <INVResponseDeserializer>
