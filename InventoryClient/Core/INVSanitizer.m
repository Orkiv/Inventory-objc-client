#import "INVSanitizer.h"
#import "INVObject.h"
#import "INVQueryParamCollection.h"
#import <ISO8601/ISO8601.h>

NSString * INVPercentEscapedStringFromString(NSString *string) {
    static NSString * const kINVCharactersGeneralDelimitersToEncode = @":#[]@";
    static NSString * const kINVCharactersSubDelimitersToEncode = @"!$&'()*+,;=";

    NSMutableCharacterSet * allowedCharacterSet = [[NSCharacterSet URLQueryAllowedCharacterSet] mutableCopy];
    [allowedCharacterSet removeCharactersInString:[kINVCharactersGeneralDelimitersToEncode stringByAppendingString:kINVCharactersSubDelimitersToEncode]];
...
- (id) sanitizeForSerialization:(id) object {
    ...
    else if ([object isKindOfClass:[NSString class]] || [object isKindOfClass:[NSNumber class]] || [object isKindOfClass:[INVQueryParamCollection class]]) {
        return object;
    }
    ...
    else if ([object isKindOfClass:[INVObject class]]) {
